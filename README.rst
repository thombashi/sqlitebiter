...
.. image:: https://github.com/thombashi/sqlitebiter/workflows/Tests/badge.svg
    :target: https://github.com/thombashi/sqlitebiter/actions?query=workflow%3ATests
    :alt: Linux/macOS/Windows test CI status
...
.. image:: https://img.shields.io/travis/thombashi/sqlitebiter/master.svg?label=Linux/macOS%20CI
   ...
   :alt: Linux/macOS build CI status
